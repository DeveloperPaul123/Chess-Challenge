...
namespace Leonidas.Uci
{
    internal class Uci
    {
        ...
        private readonly ChallengeController.PlayerType _playerType;
        private Board _board;

        public Uci(ChallengeController.PlayerType playerType)
        {
        ...
        private void Reset()
        {
            IChessBot defaultBot = new MyBot();
            _bot = ChallengeController.CreateBot(_playerType) ?? defaultBot;
