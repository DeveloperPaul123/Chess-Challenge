...
namespace Chess_Challenge.Tests
{
    ...
    {
        private readonly MyBot _myBot = new();
        private List<KeyValuePair<string, string>> _testPositions;

        [TestInitialize]
        public void Initialize()
        {
            _testPositions = new List<KeyValuePair<string, string>>
            {
        ...
        public void TestExpectedPositions()
        {
            ...
            foreach (var testPosition in _testPositions)
            {
